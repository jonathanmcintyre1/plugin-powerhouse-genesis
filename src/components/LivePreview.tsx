...
const LivePreview: React.FC = () => {
  return (
    <Card className="w-full border-[#e0e0e0] shadow-sm hover:shadow-md transition-shadow duration-300">
      <CardHeader className="bg-gradient-to-r from-[#8B0016]/5 to-[#CC0000]/5 border-b border-[#e0e0e0]">
        <CardTitle className="text-sm flex items-center">
          <Lock className="h-4 w-4 text-[#8B0016] mr-2" />
          Live Preview
        </CardTitle>
      ...
      <CardContent className="p-0">
        <div className="relative w-full h-[300px] bg-white border-t border-[#e0e0e0]">
          ...
          <div className="absolute bottom-2 right-2">
            <div className="bg-gradient-to-r from-[#8B0016]/10 to-[#CC0000]/10 text-[#CC0000] border border-[#CC0000]/20 rounded-full px-2 py-1 text-xs flex items-center">
